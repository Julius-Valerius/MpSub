...
Let $\beta_k \coloneqq \|\bm D_k\|_2$. Since the spectral norm is bounded by the Frobenius norm, we have
\[
...
\]
which immediately implies $\sup_k \mathbb E[\beta_k\mid\mathcal F_k] \le \sqrt{p} < \infty$ and $\sup_k \mathbb E[\beta_k^2\mid\mathcal F_k] \le p < \infty$.
